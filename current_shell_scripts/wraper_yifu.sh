input_dirs=(\
"/media/luanlab/Data_Processing/Jim-Zhang/Spike-Sort/converted/data_mda/Yifu/2021-09-02-aged-Treadmill/n2021-12-10-PS"\
  )
ouput_dirs=(\
"/media/luanlab/DATA/SpikeSorting/SpikeSortOut/2021-09-02-aged-Treadmill/n2021-12-10-PS"\
 )
